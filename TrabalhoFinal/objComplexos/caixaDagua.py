...
m_cilindro = 10
h_cilindro = 40 
centro_cilindro = Ponto(120, -110, -200) #Ponto(0, -60, -200) -150
...
m_cilindro = 10
h_cilindro = 40 
centro_cilindro = Ponto(120, -150, -215) #Ponto(0, -60, -200) -150
#d_cil = Vetor(-1/math.sqrt(3), 1/math.sqrt(3), -1/math.sqrt(3))
d_cil = Vetor(0, 1, 0)
K_d_cilindro= Vetor(0.824, 0.706, 0.549)
K_a_cilindro= Vetor(0.824, 0.706, 0.549)
...
m_cilindro = 10
h_cilindro = 40 
centro_cilindro = Ponto(120, -150, -185) #Ponto(0, -60, -200) -150
#d_cil = Vetor(-1/math.sqrt(3), 1/math.sqrt(3), -1/math.sqrt(3))
d_cil = Vetor(0, 1, 0)
K_d_cilindro= Vetor(0.824, 0.706, 0.549)
K_a_cilindro= Vetor(0.824, 0.706, 0.549)
...
m_cilindro = 10
h_cilindro = 40 
centro_cilindro = Ponto(135, -150, -200) #Ponto(0, -60, -200) -150
#d_cil = Vetor(-1/math.sqrt(3), 1/math.sqrt(3), -1/math.sqrt(3))
d_cil = Vetor(0, 1, 0)
K_d_cilindro= Vetor(0.824, 0.706, 0.549)
K_a_cilindro= Vetor(0.824, 0.706, 0.549)
...
m_cilindro = 10
h_cilindro = 40 
centro_cilindro = Ponto(105, -150, -200) #Ponto(0, -60, -200) -150
#d_cil = Vetor(-1/math.sqrt(3), 1/math.sqrt(3), -1/math.sqrt(3))
d_cil = Vetor(0, 1, 0)
K_d_cilindro= Vetor(0.824, 0.706, 0.549)
K_a_cilindro= Vetor(0.824, 0.706, 0.549)
