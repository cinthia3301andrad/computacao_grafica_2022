...
P_F = Ponto(0, 60 , 0) #Posição da fonte pontual situada a 5 centimetros acima do olho do observador.
...
objetos = [objeto_cone, plano_fundo , plano_chao, objeto_cilindro1, objeto_esfera1]
